class AppSettings(object):
    ...
    @property
    def PRESERVE_FIRSTNAME_CASING(self):
        return self._setting('PRESERVE_FIRSTNAME_CASING', True)
    
    @property
    def PRESERVE_LASTNAME_CASING(self):
        return self._setting('PRESERVE_LASTNAME_CASING', True)
